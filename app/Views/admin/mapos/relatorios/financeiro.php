  ...
  <div class="container-fluid">
    ...
    <div class="span4">
        <div class="widget-box">
            ...
            <div class="widget-content">
                <ul class="site-stats">
                    <li><a target="_blank" href="https://www.ultramapos.online/index.php/relatorios/financeiroRapid"><i class="icon-user"></i> <small>Relatório do mês</small></a></li>
                </ul>
            </div>
        </div>
    </div>
    ...
    <div class="span8">
        <div class="widget-box">
            ...
            <div class="widget-content">
                <form target="_blank" action="https://www.ultramapos.online/index.php/relatorios/financeiroCustom" method="get">
