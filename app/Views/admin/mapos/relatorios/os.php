    ...
    <div class="span4">
        <div class="widget-box">
            ...
            <div class="widget-content">
                <ul class="site-stats">
                    <li><a target="_blank" href="https://www.ultramapos.online/index.php/relatorios/osRapid"><i class="icon-tags"></i> <small>Todas as OS</small></a></li>
        ...
        <div class="widget-box">
            ...
            <div class="widget-content">
                <div class="span12 well">
                    ...
                    <form target="_blank" action="https://www.ultramapos.online/index.php/relatorios/osCustom" method="get">
                        <div class="span12 well">
                            <div class="span6">
